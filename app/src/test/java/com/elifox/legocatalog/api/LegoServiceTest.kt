...
class LegoServiceTest {
    ...
    private lateinit var service: _root_ide_package_.com.example.legocatalog.api.LegoService
    ...
    fun createService() {
        ...
        service = Retrofit.Builder()
                ...
                .build()
                .create(_root_ide_package_.com.example.legocatalog.api.LegoService::class.java)
    }
